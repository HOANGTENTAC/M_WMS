...
namespace M_WMS.Logics.WSB0202
{
    public class WSB0002_RegistArrival
    {
        List<TblInoutHistoryH> tblInoutHistoryHLists = new List<TblInoutHistoryH>();
        List<TblInoutHistoryD> tblInoutHistoryDLists = new List<TblInoutHistoryD>();
        public WSB0002_RegistArrival()
        {
        }
